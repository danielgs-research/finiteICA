...
function total_corr_pure_ICA_simulation(some_primes,n_sources,n_samples,
										n_trials,qica_min_k,qica_max_k,the_distribution)
	...
	saved_sim_str = strftime("_end_%d_%m_%Y_%H_%M_sim_total_corr_pure_ICA",localtime(time()));
